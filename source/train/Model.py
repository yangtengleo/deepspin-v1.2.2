...
class Model() :
    ...
    def __init__ (self, jdata, descrpt, fitting):
        ...
        self.ntypes_spin = self.descrpt.get_ntypes_spin()
        self.use_spin = self.descrpt.get_use_spin()
        self.spin_len = self.descrpt.get_spin_len()
        self.spin_norm = self.descrpt.get_spin_norm()
        # fitting
    ...
    def build (self, 
        ...
        dout = self.descrpt.build(coord_,
                                  atype_,
                                  natoms,
                                  box,
                                  mesh,
        ...
        if self.use_spin is None :
            ...
            energy_raw = tf.reshape(energy_raw, [-1, real_nloc], name = 'o_atom_energy'+suffix)
        ...
        if self.use_spin is None:
            ...
            force, virial, atom_virial = self.descrpt.prod_force_virial_spin (atom_ener, natoms, atype)
